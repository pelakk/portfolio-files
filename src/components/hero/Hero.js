...
function Hero() {
  ...
  return (
    <Container>
        ...
        <p className='text-xl color-secondary desc'>The target of this website is to show yourself my skills 
            and projects I took a part of. Make sure you check my socials to see more. </p>
